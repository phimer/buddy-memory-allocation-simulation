    ...
    then
        ...
        then
            ...
            then
                ...
                echo "$idCountPlusOne wurde in taskidlist geschrieben"
    ...
    do
        ...
        do  
            ...
            then
                ...
                #buddys addieren
                echo -e "\e[45mBUDDYS ADDIEREN\e[0m"
                printList
                echo "eleCount $eleCount"
                echo "elemCount $elemCount"
